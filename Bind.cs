...
namespace Codefarts.UIControls
{
    ...
    public static class Bind
    {
        ...
        static IDisposable CreateComplex(Expression left, Expression right)
        {
            ...
            object leftTarget = EvalExpression(leftMemEx.Expression);
        ...
        class BindingMember
        {
            ...
            {
                object target = EvalExpression(memEx.Expression);
                string propName = memEx.Member.Name;
                PropertyInfo propInfo = target.GetType().GetProperties().First(p => p.Name == propName);
